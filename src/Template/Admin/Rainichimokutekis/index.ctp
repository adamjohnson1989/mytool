    ...
    <div class="col-md-12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-plane"></i>Lý Do Muốn Làm Việc Tại Nhật
                </div>
            </div>
            <div class="portlet-body">
                        ...
                        <div class="col-md-6">
                            <div class="btn-group">
                                ...
                                echo $this->Html->link(
                                    ...
                                    ['controller' => 'Rainichimokutekis','action' => 'add'],
                ...
                <table class="table table-striped table-hover" id="sample_1">
                    ...
                    <tr>
                        ...
                        <th scope="col"><?=  __('Lý Do Muốn Làm Việc Ở Nhật (VN)') ?></th>
                        <th scope="col"><?= __('Lý Do Muốn Làm Việc Ở Nhật (JP)') ?></th>
                        <th scope="col"><?= __('Trạng Thái') ?></th>
                        <th scope="col"><?= __('Tools') ?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php foreach ($rainichimokutekis as $rainichimokuteki): ?>
                        <tr class="odd gradeX">
                            <td><?= $this->Number->format($rainichimokuteki->id) ?></td>
                            <td><?= h($rainichimokuteki->name) ?></td>
                            <td><?= h($rainichimokuteki->name_jp) ?></td>
                            <td>
                                <?php if($this->Number->format($rainichimokuteki->status) == 1):?>
