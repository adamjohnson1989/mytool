    ...
    <div class="col-md-12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i>Danh Sách Tính Cách
                </div>
            </div>
            <div class="portlet-body">
                        ...
                        <div class="col-md-6">
                            <div class="btn-group">
                                ...
                                echo $this->Html->link(
                                    ...
                                    ['controller' => 'Seikakus','action' => 'add'],
                ...
                <table class="table table-striped table-hover" id="sample_1">
                    ...
                    <tr>
                        ...
                        <th scope="col"><?=  __('Tính Cách (VN)') ?></th>
                        <th scope="col"><?= __('Tính Cách (JP)') ?></th>
                        <th scope="col"><?= __('Trạng Thái') ?></th>
                        <th scope="col"><?= __('Tools') ?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php foreach ($seikakus as $seikaku): ?>
                        <tr class="odd gradeX">
                            <td><?= $this->Number->format($seikaku->id) ?></td>
                            <td><?= h($seikaku->name) ?></td>
                            <td><?= h($seikaku->name_jp) ?></td>
                            <td>
                                <?php if($this->Number->format($seikaku->status) == 1):?>
