    ...
    <div class="col-md-12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-diamond"></i>Dự Định Sau Khi Về Nước
                </div>
            </div>
            <div class="portlet-body">
                        ...
                        <div class="col-md-6">
                            <div class="btn-group">
                                ...
                                echo $this->Html->link(
                                    ...
                                    ['controller' => 'Kikokukibous','action' => 'add'],
                ...
                <table class="table table-striped table-hover" id="sample_1">
                    ...
                    <tr>
                        ...
                        <th scope="col"><?=  __('Dự Định Sau Khi Về Nước (VN)') ?></th>
                        <th scope="col"><?= __('Dự Định Sau Khi Về Nước (JP)') ?></th>
                        <th scope="col"><?= __('Trạng Thái') ?></th>
                        <th scope="col"><?= __('Tools') ?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php foreach ($kikokukibous as $kikokukibou): ?>
                        <tr class="odd gradeX">
                            <td><?= $this->Number->format($kikokukibou->id) ?></td>
                            <td><?= h($kikokukibou->name) ?></td>
                            <td><?= h($kikokukibou->name_jp) ?></td>
                            <td>
                                <?php if($this->Number->format($kikokukibou->status) == 1):?>
