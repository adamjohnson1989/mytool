    ...
    <div class="col-md-12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-futbol-o"></i>Sở Thích
                </div>
            </div>
            <div class="portlet-body">
                ...
                <table class="table table-striped table-hover" id="sample_1">
                    ...
                    <tr>
                        ...
                        <th scope="col"><?=  __('Sở Thích (VN)') ?></th>
                        <th scope="col"><?= __('Sở Thích (JP)') ?></th>
                        <th scope="col"><?= __('Trạng Thái') ?></th>
                        <th scope="col"><?= __('Tools') ?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php foreach ($shuumis as $shuumi): ?>
                        <tr class="odd gradeX">
                            <td><?= $this->Number->format($shuumi->id) ?></td>
                            <td><?= h($shuumi->name) ?></td>
                            <td><?= h($shuumi->name_jp) ?></td>
                            <td>
                                <?php if($this->Number->format($shuumi->status) == 1):?>
