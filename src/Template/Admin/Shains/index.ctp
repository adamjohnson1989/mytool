    ...
    <div class="col-md-12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-user-circle"></i>Danh Sách Nhân Viên
                </div>
            </div>
            <div class="portlet-body">
                ...
                <table class="table table-striped table-hover" id="sample_1">
                    ...
                    <tr>
                        ...
                        <th scope="col"><?=  __('Tên Nhân Viên') ?></th>
                    ...
                    <tbody>
                    <?php foreach ($shains as $shain): ?>
                        <tr class="odd gradeX">
                            <td><?= $this->Number->format($shain->id) ?></td>
                            <td><?= h($shain->name) ?></td>
                            <td><?= h($shain->tel) ?></td>
                            <td><?= h($shain->email) ?></td>
                            <td class="actions">
