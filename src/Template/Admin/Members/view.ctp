        ...
        <div class="profile-sidebar">
            ...
            <div class="portlet light profile-sidebar-portlet ">
                ...
                <div class="profile-userpic">
                    <img src="<?= $member->image ?>" class="img-responsive" alt="<?= h($member->name) ?>"> </div>
                <!-- END SIDEBAR USERPIC -->
                <!-- SIDEBAR USER TITLE -->
                <div class="profile-usertitle">
                    <div class="profile-usertitle-name"> <?= h($member->name) ?> </div>
                    <div class="profile-usertitle-job"> MSHV:  <?= h($member->my_number) ?></div>
                </div>
            ...
            <div class="portlet light ">
                ...
                <div>
                    <h4 class="profile-desc-title">
                        <span class="caption-subject font-blue-madison bold uppercase">Thông Tin Cơ Bản</span></h4>
                    <div class="table-scrollable table-scrollable-borderless">
                        <table class="table table-hover table-light">
                            <tr>
                                <td class="fit" style=" width:35%">
                                    <?= __('Ngày Sinh:') ?>
                                <td>
                                    <?= h($member->birthday) ?>
                                </td>
                        ...
                        <div class="bl-member">
                            <div class="portlet-title">
                                <div class="caption caption-md">
                                    ...
                                    <span class="caption-subject font-blue-madison bold uppercase">Trình Độ Học Vấn</span>
                                </div>
                            </div>
                            <div class="portlet-body">
                                <div class="table-scrollable table-scrollable-borderless">
                                    <?php echo  $this->cell('Gakureiki', [$member->id]) ?>
                                </div>
                            </div>
                        </div>
                        <div class="bl-member">
                            <div class="portlet-title">
                                <div class="caption caption-md">
                                    <i class="icon-bar-chart theme-font hide"></i>
                                    <span class="caption-subject font-blue-madison bold uppercase">Kinh Nghiệm</span>
                                </div>
                            </div>
                            <div class="portlet-body">
                                <div class="table-scrollable table-scrollable-borderless">
                                    <?php echo  $this->cell('Gakureiki::keiken', [$member->id]) ?>
                                </div>
                            </div>
                        </div>
                        <div class="bl-member">
                            <div class="portlet-title">
                                <div class="caption caption-md">
                                    <i class="icon-bar-chart theme-font hide"></i>
                                    <span class="caption-subject font-blue-madison bold uppercase">Thành Phần Gia Đình</span>
                                </div>
                            </div>
                            <div class="portlet-body">
                                <div class="table-scrollable table-scrollable-borderless">
